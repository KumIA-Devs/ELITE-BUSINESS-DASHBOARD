...
BACKEND_URL = "https://c4d99afc-2646-4936-8985-48c99260c1d8.preview.emergentagent.com/api"
...
class KumiaReservationTester:
    ...
    def test_table_availability(self):
        ...
        try:
            ...
            response = self.session.get(f"{self.base_url}/tables/availability", params=availability_data)
