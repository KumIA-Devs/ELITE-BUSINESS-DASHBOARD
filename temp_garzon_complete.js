  ...
  const IncentivesSection = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => alert('Funcionalidad de crear incentivo - Próximamente')}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={() => alert('Sistema de reconocimiento - Funcionalidad próximamente')}
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <button 
              onClick={() => alert('Configuración de distribución de propinas - Funcionalidad próximamente')}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• {selectedWaiter.totalOrders} órdenes atendidas</li>
                    <li>• Rating promedio de {selectedWaiter.rating}</li>
                    <li>• {selectedWaiter.hoursWorked} horas trabajadas</li>
      ...
      {showWaiterDetailsModal && selectedWaiter && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-screen overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-800">📊 Detalles del Garzón</h2>
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Performance Metrics */}
                <div className="space-y-4">
                  <h4 className="text-lg font-bold text-gray-800">📈 Métricas de Rendimiento</h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <div className="text-xs text-green-700">Órdenes Totales</div>
                    </div>
                    ...
                    <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
                      ...
                      <div className="text-xs text-purple-700">Satisfacción Cliente</div>
                    </div>
                  </div>
                ...
                {/* Goals and Alerts */}
                <div className="space-y-4">
                  <h4 className="text-lg font-bold text-gray-800">🎯 Metas y Alertas</h4>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-600 text-center">
                      {selectedWaiter.goals.current} / {selectedWaiter.goals.ordersTarget} órdenes
                    </div>
                  </div>
